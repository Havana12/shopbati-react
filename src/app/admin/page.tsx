...
export default function AdminDashboard() {
  ...
  const createDemoData = async () => {
    if (!confirm('Créer des données de démonstration pour tester les fonctionnalités ? (Cela créera des commandes et clients fictifs)')) {
      return
    }
    ...
    try {
      ...
      const demoOrders = [
        {
          ...
          customer_name: 'Jean Dubois',
          customer_email: 'jean.dubois@email.com',
          customer_phone: '06 12 34 56 78',
          total_amount: 456.78,
          status: 'delivered',
          payment_status: 'paid',
          payment_method: 'card',
          shipping_address: '123 Rue de la Construction, 75001 Paris',
          billing_address: '123 Rue de la Construction, 75001 Paris',
          items: [
            { product_id: '1', product_name: 'Ciment Portland 25kg', quantity: 2, price: 45.99, total: 91.98 },
            { product_id: '2', product_name: 'Briques Rouges', quantity: 100, price: 2.50, total: 250.00 }
          ],
        ...
        },
        {
          ...
          shipping_address: '456 Avenue du Bâtiment, 69001 Lyon',
          items: [
            { product_id: '3', product_name: 'Carrelage Céramique', quantity: 5, price: 25.90, total: 129.50 }
          ],
      ...
      try {
        ...
        console.log('Customers collection might not exist:', error)
      }
      ...
      try {
        ...
        console.log('Orders collection might not exist:', error)
      }

      alert('✅ Données de démonstration créées avec succès!')
      fetchDashboardData()
    } catch (error) {
      console.error('Error creating demo data:', error)
      alert('❌ Erreur lors de la création des données de démonstration')
    }
  }
